insert into ramo_atividade (id, descricao) values (1, 'Alimentos');
...
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (1, '70.311.193/0001-87', 'Mercado do João', 'João Distribuido Ltda', 'LTDA', '2009-03-02', 1);
